...
export interface ItemListProps extends ThingProps {
   ...
   * @remark The order of elements in your mark-up is not sufficient for indicating the order or elements. Use ListItem with a 'position' property in such cases.
   * @see https://schema.org/itemListElement
   */
  itemListElement: Text | ListItemType | ThingType;
 ...
 */
export interface ItemList extends ItemListProps {
  "@type": "ItemList";
}

export type ItemListType = ItemList;
